...
userInputs(){
    ...
    echo -e "\n\n****** Welecome to installation of the Rasool SSH Panel ****** \n"
...
getAppVersion(){
    version=$(sudo curl -Ls "https://api.github.com/repos/RasoolHRX/Rasool/releases/latest" | grep '"tag_name":' | sed -E 's/.*"([^"]+)".*/\1/')
    echo $version;
}
...
nethogsLink=https://raw.githubusercontent.com/Alirezad07/Nethogs-Json-main/master/install.sh
